...
from open_clip import create_model_and_transforms, trace_model, get_tokenizer, create_loss, stable_adam
...
def main(args):
    ...
    optimizer = None
    # optimizer = timm.optim.create_optimizer_v2(model, 'adafactorbv')
    scaler = None

    if args.train_data or args.dataset_type == "synthetic":
        assert not args.trace, 'Cannot train with traced model'
        # print("From optimizer:{}".format(optimizer))

        opt = getattr(args, 'opt', 'adamw').lower()
        if opt.startswith('timm/'):
            # print("From tim:{}".format(optimizer))
            ...
            # print("From else:{}".format(optimizer))
            ...
            # if opt == 'adamw':
            #     print("From adaw:{}".format(optimizer))
            ...
            if opt == 'adamwsd':
                # print("From adaw:{}".format(optimizer))
                optimizer = stable_adam.StableAdamW(
                    [
                        {"params": gain_or_bias_params, "weight_decay": 0.},
                        {"params": rest_params, "weight_decay": args.wd},
                    ],
